...
export class ModuleManager {
  ...
  onAppSwitchToBackground() {
    this._forEachModule(({ module, moduleName }) => {
      ...
      try {
        ...
        console.error(`Module ${moduleName} threw error in onAppSwitchToBackground`, e);
      }
    });
  }
  ...
  onAppSwitchToForeground() {
    this._forEachModule(({ module, moduleName }) => {
      ...
      try {
        ...
        console.error(`Module ${moduleName} threw error in onAppSwitchToForeground`, e);
      }
    });
  }
  ...
  _assertPrefixIsStringAndUnique(moduleNameToAssert) {
    ...
    this._forEachModule(({ moduleName, module }) => {
      if (module.prefix && module.prefix() === prefix && moduleNameToAssert !== moduleName) {
        console.error(`Modules's prefix: ${prefix} used by 2 modules: ${moduleNameToAssert} , ${moduleName}`);
      }
    });
  }
